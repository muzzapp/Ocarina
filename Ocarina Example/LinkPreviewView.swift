...
class LinkPreviewView: UIControl {
    ...
    fileprivate func reloadContents() {
        self.previewImageView.isHidden = self.information?.imageURL ?? self.information?.twitterCard?.imageURL == nil
        ...
        if let imageURL = self.information?.imageURL ?? self.information?.twitterCard?.imageURL {
